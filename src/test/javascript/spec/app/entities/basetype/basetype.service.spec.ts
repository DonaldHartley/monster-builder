...
describe('Service Tests', () => {
  describe('Basetype Service', () => {
    let injector: TestBed;
    let service: BasetypeService;
    let httpMock: HttpTestingController;
    let elemDefault: IBasetype;
    let expectedResult: IBasetype | IBasetype[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a Basetype', () => {
        ...
        service.create(new Basetype()).subscribe(resp => (expectedResult = resp.body));
