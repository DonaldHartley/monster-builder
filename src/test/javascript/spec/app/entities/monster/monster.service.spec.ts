...
describe('Service Tests', () => {
  describe('Monster Service', () => {
    ...
    let elemDefault: IMonster;
    let expectedResult: IMonster | IMonster[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a Monster', () => {
        ...
        service.create(new Monster()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should return a list of Monster', () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            creatorId: 1,
